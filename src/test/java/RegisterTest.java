...
public class RegisterTest {
	...
	@Test
	public void test_Register_ErrorMessageGivenForPasswordContainsFirstName(){
		submitForm("jakke", "Jan", "Petersens", "jan.janssens@hotmail.com", "janismijnwachtw00rd");

		String title = driver.getTitle();
		assertEquals("Sign Up",title);

		WebElement errorMsg = driver.findElement(By.cssSelector("div.alert-danger ul li"));
		assertEquals("Your password mustn't contain your first name", errorMsg.getText());
		...
		WebElement fieldLastName=driver.findElement(By.id("lastName"));
		assertEquals("Petersens",fieldLastName.getAttribute("value"));
	...
	@Test
	public void test_Register_ErrorMessageGivenForPasswordContainsLastName(){
		submitForm("jakke", "Peter", "Jansens", "jan.janssens@hotmail.com", "Mijnwachtwoordbevatjansens");

		String title = driver.getTitle();
		assertEquals("Sign Up",title);

		WebElement errorMsg = driver.findElement(By.cssSelector("div.alert-danger ul li"));
		assertEquals("Your password mustn't contain your last name", errorMsg.getText());

		WebElement fieldUserid=driver.findElement(By.id("userid"));
		assertEquals("jakke",fieldUserid.getAttribute("value"));

		WebElement fieldFirstName=driver.findElement(By.id("firstName"));
		assertEquals("Peter",fieldFirstName.getAttribute("value"));

		WebElement fieldLastName=driver.findElement(By.id("lastName"));
		assertEquals("Jansens",fieldLastName.getAttribute("value"));
	...
	@Test
	public void test_Register_ErrorMessageGivenForPasswordTooShort(){
		submitForm("jakke", "Peter", "Jansens", "jan.janssens@hotmail.com", "123");

		String title = driver.getTitle();
		assertEquals("Sign Up",title);

		WebElement errorMsg = driver.findElement(By.cssSelector("div.alert-danger ul li"));
		assertEquals("Your password must be at least 4 characters long", errorMsg.getText());
	...
	@Test
	public void test_Register_ErrorMessageGivenForPasswordNoCapitals(){
		submitForm("jakke", "Peter", "Jansens", "jan.janssens@hotmail.com", "enkellowercase");

		String title = driver.getTitle();
		assertEquals("Sign Up",title);

		WebElement errorMsg = driver.findElement(By.cssSelector("div.alert-danger ul li"));
		assertEquals("Your password must contain at least one capital letter", errorMsg.getText());
	...
	public void test_Register_UserAlreadyExists_ErrorMessageGiven(){
		...
		submitForm(useridRandom, "Pieter", "Pieters", "pieter.pieters@hotmail.com", "1234A");
